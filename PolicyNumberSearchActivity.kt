...
import com.example.insuranceendorsementapp.Adapter.PolicyAdapter
import com.example.insuranceendorsementapp.Adapter.RecyclerviewAdapter
import com.example.insuranceendorsementapp.Database.AppDatabase
import com.example.insuranceendorsementapp.Database.Dao.PolicyNumberTableDao

import com.example.insuranceendorsementapp.Database.Table.PolicyNumberTable
                ...
                if (days.equals("30")) {
                    ...
                    if (ActivityCompat.checkSelfPermission(
                        ...
                        smsManager.sendTextMessage(
                            ...
                            null,
                            "Greetings from ABC INSURANCE COMPANY. This message is to notify you that about the end of the endorsement period of your policy.  Please ensure that you would endorse  it before the last date of " + InsurancenumberModelclass.DTT_EXPIRY_DATE + " and your ref policy number : " + InsurancenumberModelclass.VCH_POLICY_NO,
                            null,
                            null
                        )
                        Toast.makeText(
                        ...
                        intent.putExtra(
                            Intent.EXTRA_TEXT,
                            "Greetings from ABC INSURANCE COMPANY. This message is to notify you that about the end of the endorse period of your policy.  Please ensure that you would endorse it before the last date of " + InsurancenumberModelclass.DTT_EXPIRY_DATE + " and your ref policy number : " + InsurancenumberModelclass.VCH_POLICY_NO
                        )
